...
import '../../food_description/widgets/add_to_cart_widget.dart';
...
class MyOrdersPage extends StatefulWidget {
  ...
  const MyOrdersPage({super.key, required this.bgColor});
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                bodyOfMyOrders(context, listOfCartModel, widget),
              ],
            ),
          ),
        ),
...
Widget bodyOfMyOrders(BuildContext context, List<CartModel> listOfCartModel,
    MyOrdersPage widget) {
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(
          height: 300,
          child: MyOrderList(listOfCartModel: listOfCartModel),
        ),
        Column(
          children: [
            const SizedBox(
                        ...
                        child: SizedBox(
                          ...
                          child: TextField(
                            ...
                            decoration:  InputDecoration(
                                ...
                                hintStyle:
                                    const TextStyle(fontFamily: 'OriginalSurfer')),
                          ),
                        ),
                      ),
                    ),
